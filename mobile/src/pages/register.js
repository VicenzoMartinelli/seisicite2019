...
export default function Register({ navigation }) {
  ...
  const InputWithErrorError = ({ error, ...props }) => (
    <View style={{ height: 55, flex: 1 }}>
      <Input autoCompleteType="off" {...props} />
  ...
  const schema = yup.object().shape({
    modalities: yup.array().min(1, "Informe no mínimo uma modalidade"),
    institution: yup.string().required("Informe uma instituição"),
                ...
                {({ values, errors, touched, setFieldValue }) => {
                  return (
                    <Form style={{ padding: 10 }}>
                      ...
                      <Label style={{ color: "#a3a3a3", marginLeft: 10 }}>
                        ...
                        <View style={{ flex: 1 }}>
                          <SectionedMultiSelect
                            ...
                            onSelectedItemsChange={x =>
                              setFieldValue("modalities", x)
                            }
                            selectedItems={values.modalities}
                          />
                          {errors.modalities && touched.modalities && (
